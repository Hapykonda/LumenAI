...
const EXPERIENCES: Record<string, ModuleExperience> = {
  overview: experience("overview", "/panel/overview", "Command Center · Overview", "Entiende tu empresa.", "Decide qué sigue.", "Salud, cambios, impacto y decisiones en una lectura ejecutiva conectada con los demás pilares.", "Lectura en vivo", "Abrir Pulse Brief", "/panel/radar", "command", "#4f7cff", "10", LayoutDashboard, ["SALUD", "CAMBIOS", "DECISIONES"]),
  calibration: experience("calibration", "/panel/calibration", "Brand Intelligence · Calibration", "Una identidad coherente.", "En cada conversación.", "Construye la Brand Constitution y controla cómo piensa, comunica, vende y protege la reputación de tu empresa.", "Constitución activa", "Configurar con IA", "/panel/autoconfig", "spectrum", "#8c6cff", "01", SlidersHorizontal, ["IDENTIDAD", "CONDUCTA", "VENTAS"]),
  "config-ai": experience("config-ai", "/panel/autoconfig", "Natural Language · Config AI", "Dilo como lo piensas.", "LumenAI lo configura.", "Convierte intenciones humanas en cambios explicados, simulados, comparables y sujetos a aprobación.", "Configurador listo", "Revisar Calibration", "/panel/calibration", "conversation", "#5b7cff", "02", WandSparkles, ["INTENCIÓN", "PROPUESTA", "APROBACIÓN"]),
  "lumen-eye": experience("lumen-eye", "/panel/lumen-eye", "Business Intelligence · Lumen Eye", "Observa el negocio.", "Encuentra el patrón.", "Analiza tráfico, clientes, productos, campañas, embudos y conversiones para explicar qué funciona y dónde se pierde valor.", "Señales sincronizadas", "Consultar a Pulse", "/panel/radar", "eye", "#21a7ff", "03", Eye, ["EVENTOS", "PATRONES", "RENDIMIENTO"]),
  "pulse-radar": experience("pulse-radar", "/panel/radar", "AI Chief of Staff · Pulse Radar", "Detecta lo importante.", "Prepara la decisión.", "Interpreta la inteligencia de todo LumenAI en briefs, alertas, oportunidades, recomendaciones y seguimiento.", "Pulse observando", "Ver Overview", "/panel/overview", "radar", "#376dff", "04", HeartPulse, ["BRIEF", "EVIDENCIA", "ACCIÓN"]),
  research: experience("research", "/panel/research", "External Intelligence · Research", "Comprende el mercado.", "Con evidencia vigente.", "Investiga competencia, tendencias, precios y oportunidades externas conservando fuente, fecha y confianza.", "Fuentes preparadas", "Guardar en Knowledge", "/panel/knowledge", "research", "#00a88f", "05", Search, ["FUENTES", "HALLAZGOS", "VIGENCIA"]),
  widget: experience("widget", "/panel/widget", "Customer Experience · Widget", "Tu marca conversa.", "En cada punto de contacto.", "Diseña, prueba, instala y personaliza la experiencia pública de LumenAI por canal, página y producto.", "Preview disponible", "Probar conversación", "/panel/chat", "widget", "#ff7857", "06", BotMessageSquare, ["DISEÑO", "EXPERIENCIA", "PUBLICACIÓN"]),
  chats: experience("chats", "/panel/chat", "Omnichannel Center · Chats", "Cada conversación.", "Con contexto completo.", "Opera canales, clientes, leads y derivaciones en modos AI, Copilot y Human desde un solo lugar.", "Canales conectados", "Ver leads", "/panel/chat?view=leads", "chat", "#2f87ff", "07", MessagesSquare, ["CLIENTE", "CONTEXTO", "PRÓXIMA ACCIÓN"]),
  knowledge: experience("knowledge", "/panel/knowledge", "Business Memory · Knowledge", "Todo lo que la empresa sabe.", "Siempre verificable.", "Centraliza productos, servicios, inventario, políticas, documentos y salud del conocimiento.", "Memoria conectada", "Revisar Calibration", "/panel/calibration", "knowledge", "#23a474", "08", BrainCircuit, ["INFORMACIÓN", "VIGENCIA", "COBERTURA"]),
  interface: experience("interface", "/panel/interface", "Personal Workspace · Interface", "Un sistema profesional.", "Adaptado a ti.", "Personaliza la experiencia del propietario sin alterar el Widget que ven tus clientes.", "Preferencias locales", "Gestionar cuenta", "/panel/access", "appearance", "#b06cff", "09", Palette, ["TEMA", "DENSIDAD", "MOVIMIENTO"]),
  access: experience("access", "/panel/access", "Identity & Onboarding · Access", "Entra con seguridad.", "Empieza con claridad.", "Gestiona identidad, organización, roles, sesiones y el recorrido inicial de preparación empresarial.", "Identidad protegida", "Volver a Overview", "/panel/overview", "settings", "#607087", "11", ShieldCheck, ["IDENTIDAD", "ORGANIZACIÓN", "SEGURIDAD"]),
};
