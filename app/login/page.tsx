  ...
  return (
    <main className={styles.shell}>
      ...
      <section className={styles.intro} aria-label="LumenAI, inteligencia propia">
        <Image className={styles.artwork} src="/brand/editorial/lumenai-mesh-blue.webp" alt="" fill priority sizes="(max-width: 800px) 100vw, 54vw" />
        ...
        <div className={styles.manifesto}>
          ...
          <p>Atención, conocimiento y decisiones.<br />El espacio de trabajo de tu empresa.</p>
        </div>
      </section>
            ...
            <div className="mb-6 flex items-start justify-between gap-4">
              <div>
                <h2 className="mt-2 text-3xl font-black tracking-[-0.045em] text-white">
                  {passwordMode ? <>Inicia sesión.</> : <>Bienvenido.</>}
                </h2>
