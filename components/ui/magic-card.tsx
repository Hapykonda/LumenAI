    ...
    <motion.div
      ...
      style={{
        background: useMotionTemplate`
          linear-gradient(var(--lmn-magic-card-bg, rgba(8, 11, 18, .92)) 0 0) padding-box,
          radial-gradient(${gradientSize}px circle at ${mouseX}px ${mouseY}px,
            ${gradientFrom},
            ${gradientTo},
            var(--lmn-magic-card-border, rgba(255, 255, 255, .075)) 100%
          ) border-box
        `,
      }}
    >
      <div
        ...
        style={{ background: "var(--lmn-magic-card-bg, rgba(8, 11, 18, .92))" }}
      />
