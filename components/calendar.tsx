...
const buttonClassNames =
  "relative flex h-10 w-10 text-base sm:text-sm items-center justify-center rounded-lg text-foreground not-in-data-selected:hover:bg-accent disabled:pointer-events-none disabled:opacity-64 [&_svg:not([class*='opacity-'])]:opacity-80 [&_svg:not([class*='size-'])]:size-4 sm:[&_svg:not([class*='size-'])]:size-4 [&_svg]:pointer-events-none [&_svg]:shrink-0";
...
export function Calendar({
  ...
  const defaultClassNames = {
    ...
    dropdown_root:
      "relative has-focus:border-ring has-focus:ring-ring/50 has-focus:ring-[3px] border border-input rounded-lg px-3 h-9 sm:h-8 [&_svg:not([class*='opacity-'])]:opacity-80 [&_svg:not([class*='size-'])]:size-4 sm:[&_svg:not([class*='size-'])]:size-4 [&_svg]:pointer-events-none [&_svg]:-me-1",
    dropdowns:
      "w-full flex items-center text-base sm:text-sm justify-center h-10 gap-1.5 *:[span]:font-medium",
    hidden: "invisible",
    month: "w-full",
    month_caption:
      "relative mx-10 px-1 mb-1 flex h-10 items-center justify-center z-2",
    ...
    week_number:
      "h-10 w-10 p-0 text-xs font-medium text-muted-foreground/72",
    weekday:
      "h-10 w-10 p-0 text-xs font-medium text-muted-foreground/72",
  };
