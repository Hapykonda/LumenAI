...
const GUIDES: Array<{ prefix: string; guide: PulseSectionGuide }> = [
  ...
  guide("/panel/lumenite", "lumenite", "Lumenite Action OS", "Convierte decisiones en acciones", "Desde aquí puedes preparar, revisar y ejecutar flujos operativos con trazabilidad y aprobación humana.", "Explícame cómo crear mi primera acción", "recommendation", "/panel/system-health", "Comprobar conexiones"),
